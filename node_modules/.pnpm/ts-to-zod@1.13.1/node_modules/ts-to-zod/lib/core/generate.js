 ...
 */
function generate({ sourceText, maxRun = 10, nameFilter = () => true, jsDocTagFilter = () => true, getSchemaName = (id) => (0, case_1.camel)(id) + "Schema", keepComments = false, skipParseJSDoc = false, }) {
