...
module.exports = `;
    if (answers) {
        ...
        await (0, fs_extra_1.outputFile)(configPath, prettier_1.default.format(header + JSON.stringify(answers.config), Object.assign({ parser: "babel" }, prettierConfig)), "utf-8");
        return true;
    }
    return false;
}
